...
const DOSSIERS: Dossier[] = [
  { codename: "Mandarin", latin: "Agente vociferador", status: "ACTIVO", clearance: "Aurum VII", chapter: "Valencia", specialty: "Liderazgo & Organización", markers: 1, notes: "Impulsivo, pero efectivo. Sólo es discreto cuando duerme", bio: "Operativo veterano especializado en camuflaje y combate táctico. Su capacidad para ser un motor incansable y resolver situaciones críticas le ha convertido en uno de los agentes más fiables de la Comisión. Destaca por su liderazgo, capacidad organizativa y una inagotable predisposición para asumir cualquier misión. Entre operaciones mantiene tres hábitos considerados estratégicos para su rendimiento: el almuerzo, la siesta y la adquisición prácticamente compulsiva de nuevos trajes de kevlar y artilugios de última generación. La discreción no figura entre las fortalezas del sujeto; presenta una marcada tendencia a elevar el volumen de voz incluso en entornos donde el anonimato resulta recomendable. Se aprueba la asignación conjunta con la Agente MINERVA para compensar dichas vulnerabilidades y maximizar las probabilidades de éxito de la misión.",},
